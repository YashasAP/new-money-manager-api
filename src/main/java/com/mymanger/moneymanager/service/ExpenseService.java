...
public class ExpenseService {
    ...
    //helper methods
    private ExpenseEntity toEntity(ExpenseDTO dto, ProfileEntity profile, CatagoryEntity category) {
